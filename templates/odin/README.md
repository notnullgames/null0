...
A starter [null0](https://notnull.games/null0) cart, in Odin.
...
Everything is built inside docker, so you never install odin, freestanding wasm32 yourself. All you need is [docker](https://docs.docker.com/get-started/get-docker/), plus [node](https://nodejs.org/) for the shortcuts below.
...
docker run --rm --user $(id -u):$(id -g) -v ./cart:/src -v ./webroot:/out ghcr.io/notnullgames/null0-cart-odin:latest mygame
```

## writing your game

Your code is in `cart/main.odin`. A cart implements the callbacks it cares about and the host skips the rest:
...
You do not need to copy any null0 bindings into this project - the docker image bakes the current [`carts/odin/null0/null0.odin`](https://raw.githubusercontent.com/notnullgames/null0/main/carts/odin/null0/null0.odin) in for you.

## docs

- [Odin carts](https://notnull.games/null0/languages/odin) - the whole API, in Odin
