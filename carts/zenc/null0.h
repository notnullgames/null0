...
extern void draw_polygon(i32* points, i32 numPoints, u8* color);
...
extern void draw_polygon_on_image(u32 destination, i32* points, i32 numPoints, u8* color);
...
extern void draw_polygon_outline(i32* points, i32 numPoints, i32 thickness, u8* color);
...
extern void draw_polygon_outline_on_image(u32 destination, i32* points, i32 numPoints, i32 thickness, u8* color);
