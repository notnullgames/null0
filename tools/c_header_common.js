// Shared C-header generation: types/structs/enums/constants/callbacks and
// the arg/return type maps are identical for every language whose cart
// compiles through a real C header (currently just carts/c/null0.h, used
// directly by gen_cart_c.js and gen_cart_zenc.js). Keeping this in one
// place means the two can't drift.

export const cPreamble = `#include <stdarg.h>
#include <stdbool.h>
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
...
export const cArgsMap = (args) =>
  Object.entries(args)
    .map(([name, type]) => `${cArgTypes[type] || type} ${name}`)
    .join(', ')
